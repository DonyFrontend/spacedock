...
const ExploreCards = () => {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 auto-rows-auto grid-rows-1 gap-14">
          ...
          >
            <div className="flex w-full justify-between items-center">
              ...
              <img
                src={arrow_right}
                alt="arrow"
                className="w-8 h-8 m-auto group-hover:translate-x-1 transition-transform"
              />
            </div>
